////////////////////////////////////////////////////////////////////////////////////
// $Id: bktbhdr.cpp,v 1.1.1.1 2005/05/27 09:44:26 woods Exp $
//
...
static char id[] = "$Id: bktbhdr.cpp,v 1.1.1.1 2005/05/27 09:44:26 woods Exp $";
...
DLLEXPORT int WINAPI BKC_OnPlugInInfo(LPBKPLUGININFO lpPlugInInfo)
{
	...
	*/
    strcpy(lpPlugInInfo->szPlugInName, "Show Header On TitleBar");
